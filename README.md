# 🛒 EasyCart – Data Analytics – Hackathon Project🏆
...
### Key Outcomes
- 🥉 Ranked **Top 1 out of ~30 teams** in the hackathon
...
- Added bonus sentiment analysis layer using Python
...
![Dashboard Demo](05_images/Dashboard.gif)
...
**EasyCart**, an online retail business, was struggling with three critical issues reported by three different managers:
...
```
easycart-business-performance-analytics/
│
├── 📄 README.md
├── 📄 .gitignore
│
...
![Data Model](05_images/data_model.png)
